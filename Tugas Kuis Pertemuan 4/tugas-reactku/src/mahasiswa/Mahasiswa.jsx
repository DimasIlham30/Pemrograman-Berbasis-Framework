...
import Mahasiswaku from "../component/Mahasiswaku";
            ...
            <div>
                ...
                </div> 
                {
                    this.state.listMahasiswa.map(Mahasiswa => {
                        return <Mahasiswaku key={Mahasiswa.nim} NIM={Mahasiswa.nim} nama={Mahasiswa.nama} alamat={Mahasiswa.alamat} hp={Mahasiswa.hp} angkatan={Mahasiswa.angkatan} status={Mahasiswa.status} hapusMahasiswa={this.handleHapusMahasiswa}/>
                    })
                }
            </div>
        )
